...
<body>
		<!-- header -->
		<div class="header">
			<a href="http://www.sbk.cn"><img src="/images/logo.png" border="0" /><span>欢迎注册</span></a>
		</div>
...
<div class="reg_main reg_border regTab" id="perDiv">
    <ul class="individualUserBg">
        <form id="regForm_mod" name="regForm_mod" method="post"  >
            ...
            <li class="regMb30">
                <label><font>*</font> 验证邮箱：</label>
                <span class="regM defaultBorder">
            	<input id="email" name="email" autocomplete="off" class="regInput" type="text" onfocus="showtip('email','emailErr',11);" onblur="$('#emailErr').html('')"/>
            	<em></em>
            </span>
                <span class="regInput" id="emailErr"></span>
            </li>
			...
			<span  class="regM" style="margin-left:29px">
				...
				<a href="https://passport.sbk.cn/xy.html" target="_blank"  class="checkTitle">我已阅读并同意<font style="font-size:12px;">《沙巴克商城用户注册协议》</font></a>
			</span>
    ...
    <div class="ui-reg-tip"><a href="http://help.sbk.cn/140/6788.html" target="_blank">了解更多>></a></div>
</div>
...
<!--mainOver-->
		...
		<div class="footer">
			<span>
				<a href="http://www.sbk.cn/www/379/5109.html" rel="nofollow" class="footerlink1">关于我们</a> |
				<a href="http://www.sbk.cn/www/380/5116.html" rel="nofollow" class="footerlink1">联系我们</a> |
				<a href="http://www.sbk.cn/www/381/5117.html" rel="nofollow" class="footerlink1">招聘人才</a> |
				<a href="http://www.sbk.cn/www/330/2705.html" rel="nofollow" class="footerlink1">友情链接</a> |
				<a href="http://supplier.sbk.cn/supplierApply" rel="nofollow" class="footerlink1">供应商申请</a>
			</span>
			<p>
                宁波沙巴克电子商务有限公司<br />
                宁波市公安局顺义分局备案1101xxxxxx0890号|<a href="http://www.miibeian.gov.cn" target="_blank" rel="nofollow" class="footerlink1">京ICP备12xxx349号</a>|<a href="http://www.sbk.cn/www/174/461.html" target="_blank" rel="nofollow" class="footerlink1">企业营业执照</a><br />
				Copyright© 沙巴克商城 sbk.com 版权所有<br />
			</p>
		</div>
		<!-- /footer -->
	...
	var REGISTER={
		...
		inputcheck:function(){
            ...
            if (!reg_email.test($("#email").val())) {
                showError("email","emailErr",memArr[2]);
                flag = false;
            }
			return flag;
		},
                                        ...
                                        $.ajax({
                                            ...
                                            success : function(data) {
                                                if (data.data) {
                                                    ...
                                                    showError("email","emailErr",defaultArr[12]);
                                                }
                                            }
                                        });
				            		} else {
