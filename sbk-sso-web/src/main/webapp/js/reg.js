        ...
        $.post("/ajax/verifmobile/",{"name":"userMobile","param":val},function(data){
            if(data!="y"){
                if(data.indexOf("请直接登录")>=0){
                    ...
                    if(data.indexOf("沙巴克速运")>-1){
                        newData = "该手机在沙巴克已注册，请<a href='/' style='color:#669900'>直接登录></a>或<a href='/reg/findpass/?returnUrl=http://www.sbk.cn/' target='_blank' style='color:#669900'>找回密码></a>";
                    }
