...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
	...
	<input type="hidden" name="orderShipping.receiverName" value="余志友"/>
	<input type="hidden" name="orderShipping.receiverMobile" value="18892621587"/>
	<input type="hidden" name="orderShipping.receiverState" value="宁波"/>
	<input type="hidden" name="orderShipping.receiverCity" value="宁波"/>
	<input type="hidden" name="orderShipping.receiverDistrict" value="鄞州"/>
	<input type="hidden" name="orderShipping.receiverAddress" value="浙江省宁波市大红鹰"/>
</form>
  ...
  <div id="userAddrId" class="orderTbody ">
    ...
    <div class="orderItem">
        <div class="orderCurr" id="userAddress" style="display:block;">
          <ul>
            <li>余志友&nbsp;&nbsp;&nbsp;&nbsp;18892621587&nbsp;&nbsp;&nbsp;&nbsp;宁波市&nbsp;&nbsp;鄞州区&nbsp;&nbsp;浙江省宁波市大红鹰</li>
          </ul>
        </div>
    </div>
  </div>
		...
		<div class="shipment">
			<div class="shipOrder" id="ylsorder2">
				<div class="sOrders">
					...
					<div class="sOrders">
						<div class="scon">
							<strong>沙巴克速运</strong>负责配送。<br>商品下单后尽快为您发货
						</div>
					</div>
