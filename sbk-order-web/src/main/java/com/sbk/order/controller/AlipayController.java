...
import com.sbk.order.alipayConfig.AlipayConfig;
...
public class AlipayController {
    ...
    @ResponseBody
    public String goAlipay(String out_trade_no, String total_amount, String subject, String body) throws AlipayApiException {
        //获得初始化的AlipayClient
    ...
    public void notify_url(HttpServletRequest request) throws UnsupportedEncodingException, AlipayApiException {
